...
setup = () => {
  let canvas;
  if (windowWidth > 1200) {
      img = loadImage("back.svg");
      canvas = createCanvas(1920, 560);
  ...
  canvas.parent('header');
    ...
    //////the start button
    startButton = createButton('Click to Explore')
        ...
        .mouseOver(() => (startButton.style('background-color', "#ffffff"), (startButton.style('border', '4px solid yellow'))))
        .mouseOut(() => (startButton.style('background-color', "#336600"), (startButton.style('border', '2px solid yellow'))))
